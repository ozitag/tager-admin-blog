...
export const BLOG_POST_LIST_ROUTE: RouteRecordRaw = {
...
export const BLOG_POST_FORM_ROUTE: RouteRecordRaw = {
...
export const BLOG_CATEGORY_LIST_ROUTE: RouteRecordRaw = {
...
export const BLOG_CATEGORY_FORM_ROUTE: RouteRecordRaw = {
